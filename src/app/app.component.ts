...
import { AudioModel } from './core/models/audio.model';
...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.audio = new AudioModel("Book 1", "Audio 1", "CD 1", "Track 1", "Track 1", "CAREER PATHS INFORMATION TECHNOLOGY BOOK 1 CD1 Track 01 Credits.mp3");
